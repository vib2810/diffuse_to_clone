...
if __name__ == "__main__":
    # train_trajectory_num = get from sys args
    if len(sys.argv) < 2:
        print("Please provide the train trajectory number")
        sys.exit(0)
    
    train_trajectory_num = int(sys.argv[1])
    ...
    model_trainer = ModelTrainer(train_params)
